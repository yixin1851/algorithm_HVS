...
#ifndef ALGORITHMLIBRARY_DD5_H
#define ALGORITHMLIBRARY_DD5_H
#include "public.h"
...
int calcDD5()
{
    printf("\n - APS DD5 Start\r\n");
    //导入数据
	std::string F1 = "D:/Work/Tmp/APX003CA/TestData_CP1/APX003CB_APS_513331333139382D05033279802E85020324_X121Y128_S2_25FPS_5000K_Dark_DD5_0Lux_1p0ms_VTX1P5V_60C_G16_F1_W3264H2448P10_T2K-CP1-4S-LY_20251013220530.raw";
	std::string F2 = "D:/Work/Tmp/APX003CA/TestData_CP1/APX003CB_APS_513331333139382D05033279802E85020324_X121Y128_S2_25FPS_5000K_Dark_DD5_0Lux_1p0ms_VTX1P5V_60C_G16_F2_W3264H2448P10_T2K-CP1-4S-LY_20251013220530.raw";
	int nWidth = 3264;
	int nHeight = 2448;
	uint32_t nNumber = 2;
	...
	if(check_ret(__func__, ReadNoiseAPS(handle, 0, 1, nullptr, &ReadNoiseRes)))
	{
		setResult("ReadNoise_DD5", (double)ReadNoiseRes);
	}
	else
		return -1;

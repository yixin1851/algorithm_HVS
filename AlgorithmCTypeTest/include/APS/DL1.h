...
#ifndef ALGORITHMLIBRARY_DL1_H
#define ALGORITHMLIBRARY_DL1_H
#include "public.h"
...
int calcDL1()
{
    printf("\n - APS DL1 Start\r\n");
	//导入数据
	std::string F1 = "D:/Work/Tmp/APX003CA/TestData_CP1/APX003CB_APS_513331333139382D05033279802E85020324_X121Y128_S2_25FPS_5000K_Light_DL1_3080Lux_6p0ms_VTX1P5V_60C_G1_F1_W3264H2448P10_T2K-CP1-4S-LY_20251013220516.raw";
	std::string F2 = "D:/Work/Tmp/APX003CA/TestData_CP1/APX003CB_APS_513331333139382D05033279802E85020324_X121Y128_S2_25FPS_5000K_Light_DL1_3080Lux_6p0ms_VTX1P5V_60C_G1_F2_W3264H2448P10_T2K-CP1-4S-LY_20251013220516.raw";
	int nWidth = 3264;
	int nHeight = 2448;
	uint32_t nNumber = 2;
	...
	{
		setResult("DataMean_Total_DL1", (double)DataMean.DataMeanFrame);
		setResult("DataMean_Gb_DL1", (double)DataMean.SubFrameDataMean[0]);
		setResult("DataMean_B_DL1", (double)DataMean.SubFrameDataMean[1]);
		setResult("DataMean_R_DL1", (double)DataMean.SubFrameDataMean[2]);
		setResult("DataMean_Gr_DL1", (double)DataMean.SubFrameDataMean[3]);
	}
	else{
		return -1;
	}
	...
	{
		setResult("DataMean_Center_Total_DL1", (double)DataMean_Center.DataMeanFrame);
		setResult("DataMean_Center_Gb_DL1", (double)DataMean_Center.SubFrameDataMean[0]);
		setResult("DataMean_Center_B_DL1", (double)DataMean_Center.SubFrameDataMean[1]);
		setResult("DataMean_Center_R_DL1", (double)DataMean_Center.SubFrameDataMean[2]);
		setResult("DataMean_Center_Gr_DL1", (double)DataMean_Center.SubFrameDataMean[3]);
	}
	else{
		return -1;
	}
